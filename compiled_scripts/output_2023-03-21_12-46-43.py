...
def format_quarterly_data(df_fte, df_orm, df_ftc, df_pro_serv, df_software, df_actuals, df_fte_allocation, df_ftc_allocation, df_pro_serv_allocation, df_software_allocation, df_name_map):
    ...
    # These print statements are for debugging purposes only
    # print("unique values in df_actuals Y-budget column: ", df_actuals["Y-budget"].unique())
    # print("unique values in df_actuals Q-budget column: ", df_actuals["Q-budget"].unique())
    ...
    for year in y_budget_set:
        ...
        for quarter in range(1,5):
            ...
            for df in df_list:
                ...
                if df2.empty:
                    # print("...no data for ", year, "Q", quarter)
                    # if the quarter is 1
                    pass
                elif quarter == 1:
                    # increment the counter
                    q1_counter += 1
                    print("q1_counter: ", q1_counter)
                # if the quarter is 2
                elif quarter == 2:
                    # increment the counter
                    q2_counter += 1
                    print("q2_counter: ", q2_counter)
                    if not df_actuals_2.empty:
                        q2_actuals_bool = True
                        print("q2_actuals_bool: ", q2_actuals_bool)
                # if the quarter is 3
                elif quarter == 3:
                    # increment the counter
                    q3_counter += 1
                    print("q3_counter: ", q3_counter)
                    if not df_actuals_2.empty:
                        q3_actuals_bool = True
                        print("q3_actuals_bool: ", q3_actuals_bool)
                # if the quarter is 4
                elif quarter == 4:
                    # increment the counter
                    q4_counter += 1
                    print("q4_counter: ", q4_counter)
                    if not df_actuals_2.empty:
                        q4_actuals_bool = True
                        print("q4_actuals_bool: ", q4_actuals_bool)
        ...
        if q1_counter >= 5:
            print("Q1 Data is ready to be processed")
        ...
        if q2_counter >= 5 and q2_actuals_bool == True:
            print("Q2 Data is ready to be processed")
        ...
        if q3_counter >= 5 and q3_actuals_bool == True:
            print("Q3 Data is ready to be processed")
        ...
        if q4_counter >= 5 and q4_actuals_bool == True:
            print("Q4 Data is ready to be processed")
        ...
        # print the number of data frames in the list
        print("Number of data frames in the list: ", len(df_quarter_list))
