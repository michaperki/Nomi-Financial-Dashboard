...
# START SCRIPT
def main_function_no_actuals(df_fte, df_open_roles, df_ftc, df_pro_serv, df_software, df_actuals, df_name_map, df_fte_allocation, df_ftc_allocation, df_pro_serv_allocation, df_software_allocation):
