...
def validate_headcounts(df_fte, df_orm, df_headcounts):
    ...
    # print the head of the df_depart
    print(df_depart.head())

    # get the sum of the "Depart Headcount" column where the index is 1, if it doesn't exist, set it to 0
    depart_january = df_depart.loc[1, 'Depart Headcount'] if 1 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 2, if it doesn't exist, set it to 5
    depart_february = df_depart.loc[2, 'Depart Headcount'] if 2 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 3, if it doesn't exist, set it to 0
    depart_march = df_depart.loc[3, 'Depart Headcount'] if 3 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 4, if it doesn't exist, set it to 0
    depart_april = df_depart.loc[4, 'Depart Headcount'] if 4 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 5, if it doesn't exist, set it to 0
    depart_may = df_depart.loc[5, 'Depart Headcount'] if 5 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 6, if it doesn't exist, set it to 0
    depart_june = df_depart.loc[6, 'Depart Headcount'] if 6 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 7, if it doesn't exist, set it to 0
    depart_july = df_depart.loc[7, 'Depart Headcount'] if 7 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 8, if it doesn't exist, set it to 0
    depart_august = df_depart.loc[8, 'Depart Headcount'] if 8 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 9, if it doesn't exist, set it to 0
    depart_september = df_depart.loc[9, 'Depart Headcount'] if 9 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 10, if it doesn't exist, set it to 0
    depart_october = df_depart.loc[10, 'Depart Headcount'] if 10 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 11, if it doesn't exist, set it to 0
    depart_november = df_depart.loc[11, 'Depart Headcount'] if 11 in df_depart.index else 0
    # get the sum of the "Depart Headcount" column where the index is 12, if it doesn't exist (Duplicates hidden)
    depart_december = df_depart.loc[12, 'Depart Headcount'] if 12 in df_depart.index else 0
