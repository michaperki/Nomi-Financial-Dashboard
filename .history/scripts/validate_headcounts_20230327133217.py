...
def validate_headcounts(df_fte, df_orm, df_headcounts):
    ...
    hc_2023 = df_headcounts[df_headcounts['YEAR'] == 2023]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of 2023 values in the 'ALLOCATION' column: {hc_2023}")
    hc_2023_jan = df_headcounts[(df_headcounts['YEAR'] == 2023) & (df_headcounts['MONTH'] == '01')]['ALLOCATED_AMOUNT'].sum()
