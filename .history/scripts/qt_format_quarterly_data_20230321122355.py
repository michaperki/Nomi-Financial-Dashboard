...
# START SCRIPT
def format_quarterly_data(df_fte, df_orm, df_ftc, df_pro_serv, df_software, df_actuals, df_fte_allocation, df_ftc_allocation, df_pro_serv_allocation, df_software_allocation):
    ...
    for year in y_budget_set:
        ...
        if q1_counter >= 5:
            print_subheader("Q1 Data is ready to be processed")
        ...
        if q2_counter >= 5 and q2_actuals_bool == True:
            print_subheader("Q2 Data is ready to be processed")
        ...
        if q3_counter >= 5 and q3_actuals_bool == True:
            print_subheader("Q3 Data is ready to be processed")
        ...
        if q4_counter >= 5 and q4_actuals_bool == True:
            print_subheader("Q4 Data is ready to be processed")
