...
def validate_headcounts(df_fte, df_orm, df_headcounts):
    ...
    logging.info(f"Number of JULY 2023 values in the 'ALLOCATION' column: {hc_depart_2023_jul}")
    hc_depart_2023_aug = df[(df['YEAR'] == 2023) & (df['MONTH'] == '08')]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of AUGUST 2023 values in the 'ALLOCATION' column: {hc_depart_2023_aug}")
    hc_depart_2023_sep = df[(df['YEAR'] == 2023) & (df['MONTH'] == '09')]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of SEPTEMBER 2023 values in the 'ALLOCATION' column: {hc_depart_2023_sep}")
    hc_depart_2023_oct = df[(df['YEAR'] == 2023) & (df['MONTH'] == '10')]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of OCTOBER 2023 values in the 'ALLOCATION' column: {hc_depart_2023_oct}")
    hc_depart_2023_nov = df[(df['YEAR'] == 2023) & (df['MONTH'] == '11')]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of NOVEMBER 2023 values in the 'ALLOCATION' column: {hc_depart_2023_nov}")
    hc_depart_2023_dec = df[(df['YEAR'] == 2023) & (df['MONTH'] == '12')]['ALLOCATED_AMOUNT'].sum()
    logging.info(f"Number of DECEMBER 2023 values in the 'ALLOCATION' column: {hc_depart_2023_dec}")
