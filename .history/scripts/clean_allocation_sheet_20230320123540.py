...
def clean_allocation_sheet(df, name_map):
    ...
    # print the data frame where Clinical & Economic Research is the Vendor and the BU is not "INSIGHTS" or "NETWORK"
    print(df.loc[(df['Vendor'] == 'Clinical & Economic Research') & (df['BU'].isin(['Care','Connect']))])
