...
def clean_allocation_sheet(df, name_map):
    ...
    # melt the data frame so that each row is a QUARTER
    df_allo_total_missing = pd.melt(df_allo_total_missing,id_vars=['YEAR','Vendor','SOURCE','ALLOCATION'],value_vars=['QUARTER'],value_name='QUARTER',var_name='QUARTER_YEAR_BU')
