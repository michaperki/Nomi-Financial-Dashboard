...
def compile_scripts():
    """
    Reads all the files in the "scripts" folder and concatenates them into a single output file, ordered
    according to a predefined list. Only the piece of each script between "# START SCRIPT" and "# END SCRIPT"
    comments is included in the output. Import statements are moved to the top of the output file, and a
    logging configuration is added below the imports. The output file is saved in the "compiled_scripts" folder
    with a filename that includes the current date and time.
    """
