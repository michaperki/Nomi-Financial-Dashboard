...
graph LR;
    ...
    C(<b>Other Calculation</b> <ol><li>Headcount</li><li>Delta</li><li>Quarterly</li><li>QM Diff</li><li>Dashboard Health</li>) --> D;
    D(<b>Dashboard Health</b> <ol><li>complete data validation</li><li>add to output list</li>) --> E(<b>Output Data</b> <ol><li>concatenate output list</li><li>write to Domo<li>);
